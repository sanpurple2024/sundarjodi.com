...
class Authentication extends REST_Controller {
                ...
                if(!empty($current_logged_data)){
            		...
            		$paid_member = $this->User_model_api_3->check_membership(array("member_profile_id"=>$reg->profile,"payment_mode"=>"Paid"));
                        ...
                        $arg[] = array(
                            ...
                            "profile"=>$reg->profile,
                            "age"=>$age,
                            "height"=>substr_replace( $reg->height, $string, $position, 0 )." ft",
 ...
 //-----------------------------------------------------------------------------
    ...
    if($action == 'intr'){
        ...
        $get_education_details = $this->User_model_api_3->get_education_details(array("reg_id"=>$current_logged_data[0]->id));
        ...
        <tr>
             ...
             <td style='border:0;width:70%;'>
               <span style='font-size:14px;color:#34495E;'> Caste: $sender_caste</span><br>
                <span style='font-size:14px;color:#34495E;'> Martial status: $sender_martial_status</span><br>
...
//=============================================================================//
    ...
    function reject_interest_post(){
        ...
        //  $int_id =   $this->input->post('interest_id');
        //  $another_user =   $this->input->post('another_user_profile_id');
         $logged_user_id =   $this->input->post('logged_user_id');
...
//==============================================================================================//
  ...
  function get_caste_post(){
        ...
        if(!empty($matched_data)){
            ...
            foreach($matched_data AS $row1){
			  ...
			  $city_name = (!empty($city_get)) ? $city_get[0]->perm_city : "";
               ...
               $file_name  = (!empty($profile_img) && $profile_img[0]->file_name!="") ? "uploads/".$profile_img[0]->file_name : "image/user-img.jpg";
			 // $file_name = (!empty($profile_img)) ? $profile_img[0]->file_name : "";
			  $today = date('Y-m-d');
    ...
    function view_profile_post(){
        ...
        //         $this->response([
        //             'status' => FALSE,
        //             'message' => 'Please provide current login profile id'
        //         ], REST_Controller::HTTP_OK);
        //     }
        // }
  ...
  $arr = array();
            if(!empty($prime)){
                ...
                foreach($prime AS $key){
                        ...
                        $string = "'"; 
                        $position = '1'; 
                        // $file_path1 = FCPATH . 'uploads/'.$key['file_name']; 
                    ...
                    $arr[] = array(
                        ...
                        "caste"=>$key['caste'],
                        "dob"=>$key['dob'],
                        "height"=>substr_replace($key['height'], $string, $position, 0 )." ft",
                        "martial_status"=>$key['martial_status'],
                        "status"=>$key['status'],
                        "perm_city"=>$key['perm_city'],
                        "file_name"=>$file_name,
 ...
 //=======================================================================//
  ...
  //=======================================================================//
            ...
            if(!empty($data)){
                ...
                foreach($data AS $val){
                    ...
                    $array[] = array(
                        ...
                        "father_native_place"=>$val->father_native_place,
                        ...
                        "mother_native_place"=>$val->mother_native_place,
   ...
   function get_user_profile_photo_info_post(){
    ...
    // $data = $this->User_model_api_3->get_user_profile_photo_info_data($data);
